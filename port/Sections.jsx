...
function PalantirBadge() {
  return <span className="palantir-badge"><span className="palantir-mark">PALANTIR</span></span>;
}
  ...
  return (
    <section className="block" id="work">
      ...
      <div className="projects">
        ...
        tags={["ESP32", "RSSI", "RF", "Palantir"]}><VizSauron /></Project>
        ...
        cornerLogos={[
        { src: "assets/logo-gaussian.png", alt: "Gaussian", href: "#", label: "Gaussian" },
        { src: "assets/logo-neurolang.png", alt: "NeuroLang", href: "#", label: "NeuroLang" }]
        }
...
function Research() {
  const rows = [
  { yr: "2026", ttl: "Self-Modifying Program Synthesis via Online Library Evolution", desc: "Online library evolution for program synthesis under shifting task distributions.", venue: "arXiv preprint" },
  { yr: "2025", ttl: "Microwave Technology in Aeronautical Applications", desc: "Survey of microwave systems in aerospace communication, sensing and propulsion.", venue: "Independent" },
  { yr: "2025", ttl: "DRL vs Rule-Based Systems for Spacecraft FDIR", desc: "Comparative study of deep RL and classical rule engines for safety-critical fault handling.", venue: "Aerospace" },
  { yr: "2025", ttl: "Quantum vs Classical vs Hybrid Computing Paradigms", desc: "Performance and applicability across emerging hybrid compute stacks.", venue: "Independent" }];
  ...
  return (
    <section className="block" id="research">
      ...
      <div className="research-list reveal">
        {rows.map((r, i) =>
        <a className="research-row" key={i} href="#">
    ...
    <section className="hire" id="hire">
      <div className="hire-left">
        ...
        <div className="hire-actions reveal">
          ...
          <window.Button href="#" target="_blank">LinkedIn</window.Button>
          <window.Button href="assets/resume.pdf" target="_blank" glyph="download">Resume / CV</window.Button>
        </div>
      </div>
      <div className="hire-right reveal">
        <div className="hire-stat"><div className="num"><window.Counter to={8} duration={1200} /><span className="small">+</span></div><div className="label">Shipped projects</div></div>
        <div className="hire-stat"><div className="num"><window.Counter to={4} duration={1100} /></div><div className="label">Research papers</div></div>
        <div className="hire-stat"><div className="num"><window.Counter to={2} duration={1000} /></div><div className="label">Patents · filed/pending</div></div>
        <div className="hire-stat"><div className="num"><window.Counter to={10} duration={1400} />K<span className="small">+</span></div><div className="label">Users reached</div></div>
      </div>
    </section>);
...
function Education() {
  ...
  { logo: "assets/logo-uw.png", tag: "Target · Undergrad", name: "University of Washington", loc: "Seattle, WA", years: "Computer Science · Applying 2027", crestClass: "uw" }];
...
function Certifications() {
  ...
  { logo: "assets/logo-harvard.png", logoKind: "wide", issuer: "Harvard University", year: "2021", name: "CS50x", skills: ["Algorithms", "Web dev"], desc: "Harvard's intro to computer science — algorithms, data structures, C, Python, web." },
  ...
  { logo: "assets/logo-autodesk.png", issuer: "Autodesk · Udemy", year: "—", name: "Fusion 360 Certified", skills: ["CAD", "+7"], desc: "Parametric 3D CAD modeling for product design, simulation and fabrication." },
      ...
      <div className="certs">
        ...
        <article className="cert reveal" key={i}>
            ...
            <div className="cert-foot">
              ...
              <div className={`logo${c.logoKind ? " logo-" + c.logoKind : ""}`}><img src={c.logo} alt={c.issuer} style={{ width: "15px", height: "34px" }} /></div>
            </div>
          </article>
        )}
      </div>
...
function Leadership() {
  const items = [
  { role: "Int'l Vice President", name: "PII Research Network", desc: "Expanded the network to 20+ schools globally and 1,000+ student researchers. Built the mentorship pipeline and engineering project tracks.", href: "#", mark: "PII" },
  { role: "Sponsor Award · 2nd Overall", name: "Palantir Technologies", desc: "SAURON — RF-based search & rescue — picked up the Palantir sponsor award at hackathon for the distributed ESP32 mesh + drone verification pipeline.", href: "https://www.palantir.com/", mark: "PALANTIR", markClass: "palantir-wordmark" },
  { role: "Regional Champion", name: "Science Olympiad", desc: "First place regional in the Chemistry event; contributed to multi-event team placements across the season.", href: "#", mark: "SO" }];

  return (
    <section className="block" id="leadership">
      <window.BlockHeader tag="LEADERSHIP / NETWORK" title={<>People I've built with.</>} />
      <div className="leadership-grid">
        {items.map((it, i) =>
        <a className="lead-card reveal" key={i} href={it.href} target={it.href.startsWith("http") ? "_blank" : undefined} rel="noreferrer">
            <div className="lead-top">
              <div className={`lead-logo${it.markClass ? " " + it.markClass : ""}${it.logo ? " lead-logo-wide" : ""}`}>{it.logo ? <img src={it.logo} alt={it.name} /> : <span className="mono">{it.mark}</span>}</div>
    ...
    <section className="contact" id="contact">
      ...
      <div className="contact-grid">
        ...
        <div className="contact-meta reveal">
          ...
          <div className="field"><div className="label">LINKEDIN</div><div className="val"><a href="#">/in/chahel-paatur</a></div></div>
          <div className="field"><div className="label">GITHUB</div><div className="val"><a href="#">@chahelpaatur</a></div></div>
  ...
  return (
    <footer className="footer">
      ...
      <div className="social-row">
        <a href="#" aria-label="LinkedIn"><img src="assets/icon-linkedin.png" alt="" /></a>
        <a href="#" aria-label="GitHub"><img src="assets/icon-github.png" alt="" /></a>
